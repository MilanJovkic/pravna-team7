...
class RulebaseCodeGenerator:
    ...
    COMPATIBILITY_TEMPLATES: list[tuple[str, list[tuple[str, str]]]] = [
        ...
        ("crime_art144", [("life_consequence_type", "smrt_nastupila"), ("victim_status", "dijete")]),
        ("crime_art144", [("life_consequence_type", "smrt_nastupila"), ("victim_status", "bremenita_zena")]),
        ("crime_art144", [("life_consequence_type", "smrt_nastupila"), ("danger_to_third_parties", "true")]),
        ("crime_art144", [("life_consequence_type", "smrt_nastupila"), ("victim_count", "vise")]),
