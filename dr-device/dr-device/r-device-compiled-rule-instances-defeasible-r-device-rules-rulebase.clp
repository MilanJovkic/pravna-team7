...
([rule9-defeasibly] of derived-attribute-rule
   ...
   (implies crime_art154)
   (del-name nil)
   (derived-attribute-rule "( declare ( priority ( calc-defeasible-priority 1 [rule9] ) ) ) ?gen100 <- ( lc:case ( lc:defendant ?Defendant ) ( lc:injury_type \"teska tjelesna povreda\" ) ( positive ?gen99 & : ( >= ?gen99 1 ) ) ) ?gen102 <- ( lc:case ( lc:defendant ?Defendant ) ( lc:location \"Podgorici Kv\" ) ( positive ?gen101 & : ( >= ?gen101 1 ) ) ) ?gen93 <- ( crime_art154 ( defendant ?Defendant ) ( positive 0 ) ( negative ~ 2 ) ( positive-overruled $?gen95 & : ( not ( member$ rule9 $?gen95 ) ) ) ) ( test ( eq ( class ?gen93 ) crime_art154 ) ) => ?gen93 <- ( crime_art154 ( positive 1 ) ( positive-derivator rule9 ?gen100 ?gen102 ) )"))
...
([rule9-support] of derived-attribute-rule
   ...
   (implies crime_art154)
   (del-name nil)
   (derived-attribute-rule "( declare ( priority ( calc-defeasible-priority 5 [rule9] ) ) ) ?gen91 <- ( lc:case ( lc:defendant ?Defendant ) ( lc:injury_type \"teska tjelesna povreda\" ) ) ?gen92 <- ( lc:case ( lc:defendant ?Defendant ) ( lc:location \"Podgorici Kv\" ) ) ?gen93 <- ( crime_art154 ( defendant ?Defendant ) ( positive-support $?gen95 & : ( not ( subseq-pos ( create$ rule9 ?gen91 ?gen92 $$$ $?gen95 ) ) ) ) ) ( test ( eq ( class ?gen93 ) crime_art154 ) ) => ( calc ( bind $?gen98 ( create$ rule9 ?gen91 ?gen92 $?gen95 ) ) ) ?gen93 <- ( crime_art154 ( positive-support $?gen98 ) )"))
...
([rule7-defeasibly] of derived-attribute-rule
   ...
   (implies crime_art152_2)
   (del-name nil)
   (derived-attribute-rule "( declare ( priority ( calc-defeasible-priority 1 [rule7] ) ) ) ?gen76 <- ( lc:case ( lc:defendant ?Defendant ) ( lc:injury_type \"laka tjelesna povreda\" ) ( positive ?gen75 & : ( >= ?gen75 1 ) ) ) ?gen78 <- ( lc:case ( lc:defendant ?Defendant ) ( lc:weapon \"metalni kljuc\" ) ( positive ?gen77 & : ( >= ?gen77 1 ) ) ) ?gen69 <- ( crime_art152_2 ( defendant ?Defendant ) ( positive 0 ) ( negative ~ 2 ) ( positive-overruled $?gen71 & : ( not ( member$ rule7 $?gen71 ) ) ) ) ( test ( eq ( class ?gen69 ) crime_art152_2 ) ) => ?gen69 <- ( crime_art152_2 ( positive 1 ) ( positive-derivator rule7 ?gen76 ?gen78 ) )"))
...
([rule7-overruled] of derived-attribute-rule
   ...
   (implies crime_art152_2)
   (del-name nil)
   (derived-attribute-rule "( declare ( priority ( calc-defeasible-priority 2 [rule7] ) ) ) ?gen76 <- ( lc:case ( lc:defendant ?Defendant ) ( lc:injury_type \"laka tjelesna povreda\" ) ( positive ?gen75 & : ( >= ?gen75 1 ) ) ) ?gen78 <- ( lc:case ( lc:defendant ?Defendant ) ( lc:weapon \"metalni kljuc\" ) ( positive ?gen77 & : ( >= ?gen77 1 ) ) ) ?gen69 <- ( crime_art152_2 ( defendant ?Defendant ) ( negative-support $?gen72 ) ( negative-overruled $?gen73 & : ( not ( subseq-pos ( create$ rule7-overruled $?gen72 $$$ $?gen73 ) ) ) ) ( positive-defeated $?gen71 & : ( not ( member$ rule7 $?gen71 ) ) ) ) ( test ( eq ( class ?gen69 ) crime_art152_2 ) ) => ( calc ( bind $?gen74 ( create$ rule7-overruled $?gen72 $?gen73 ) ) ) ?gen69 <- ( crime_art152_2 ( negative-overruled $?gen74 ) )"))
...
([rule7-support] of derived-attribute-rule
   ...
   (implies crime_art152_2)
   (del-name nil)
   (derived-attribute-rule "( declare ( priority ( calc-defeasible-priority 5 [rule7] ) ) ) ?gen67 <- ( lc:case ( lc:defendant ?Defendant ) ( lc:injury_type \"laka tjelesna povreda\" ) ) ?gen68 <- ( lc:case ( lc:defendant ?Defendant ) ( lc:weapon \"metalni kljuc\" ) ) ?gen69 <- ( crime_art152_2 ( defendant ?Defendant ) ( positive-support $?gen71 & : ( not ( subseq-pos ( create$ rule7 ?gen67 ?gen68 $$$ $?gen71 ) ) ) ) ) ( test ( eq ( class ?gen69 ) crime_art152_2 ) ) => ( calc ( bind $?gen74 ( create$ rule7 ?gen67 ?gen68 $?gen71 ) ) ) ?gen69 <- ( crime_art152_2 ( positive-support $?gen74 ) )"))
...
([rule2-defeasibly] of derived-attribute-rule
   ...
   (implies crime_art151_2)
   (del-name nil)
   (derived-attribute-rule "( declare ( priority ( calc-defeasible-priority 1 [rule2] ) ) ) ?gen19 <- ( lc:case ( lc:defendant ?Defendant ) ( lc:injury_type \"teska tjelesna povreda\" ) ( positive ?gen18 & : ( >= ?gen18 1 ) ) ) ?gen21 <- ( lc:case ( lc:defendant ?Defendant ) ( lc:weapon \"metalni kljuc\" ) ( positive ?gen20 & : ( >= ?gen20 1 ) ) ) ?gen12 <- ( crime_art151_2 ( defendant ?Defendant ) ( positive 0 ) ( negative ~ 2 ) ( positive-overruled $?gen14 & : ( not ( member$ rule2 $?gen14 ) ) ) ) ( test ( eq ( class ?gen12 ) crime_art151_2 ) ) => ?gen12 <- ( crime_art151_2 ( positive 1 ) ( positive-derivator rule2 ?gen19 ?gen21 ) )"))
...
([rule2-overruled] of derived-attribute-rule
   ...
   (implies crime_art151_2)
   (del-name nil)
   (derived-attribute-rule "( declare ( priority ( calc-defeasible-priority 2 [rule2] ) ) ) ?gen19 <- ( lc:case ( lc:defendant ?Defendant ) ( lc:injury_type \"teska tjelesna povreda\" ) ( positive ?gen18 & : ( >= ?gen18 1 ) ) ) ?gen21 <- ( lc:case ( lc:defendant ?Defendant ) ( lc:weapon \"metalni kljuc\" ) ( positive ?gen20 & : ( >= ?gen20 1 ) ) ) ?gen12 <- ( crime_art151_2 ( defendant ?Defendant ) ( negative-support $?gen15 ) ( negative-overruled $?gen16 & : ( not ( subseq-pos ( create$ rule2-overruled $?gen15 $$$ $?gen16 ) ) ) ) ( positive-defeated $?gen14 & : ( not ( member$ rule2 $?gen14 ) ) ) ) ( test ( eq ( class ?gen12 ) crime_art151_2 ) ) => ( calc ( bind $?gen17 ( create$ rule2-overruled $?gen15 $?gen16 ) ) ) ?gen12 <- ( crime_art151_2 ( negative-overruled $?gen17 ) )"))
...
([rule10-deductive] of ntm-deductive-rule
   ...
   (implies crime_art155_1)
   (deductive-rule "?gen103 <- ( lc:case ( lc:defendant ?Defendant ) ( lc:injury_type \"teska tjelesna povreda\" ) ) ?gen104 <- ( lc:case ( lc:defendant ?Defendant ) ( lc:location \"Sto\" ) ) ( not ( crime_art155_1 ( defendant ?Defendant ) ) ) => ( crime_art155_1 ( defendant ?Defendant ) )")
   (production-rule "( defrule rule10-deductive-gen124 ( declare ( salience ( calc-salience crime_art155_1 ) ) ) ( run-deductive-rules ) ( object ( name ?gen103 ) ( is-a lc:case ) ( lc:defendant ?Defendant ) ( lc:injury_type \"teska tjelesna povreda\" ) ) ( object ( name ?gen104 ) ( is-a lc:case ) ( lc:defendant ?Defendant ) ( lc:location \"Sto\" ) ) ( not ( object ( is-a crime_art155_1 ) ( defendant ?Defendant ) ) ) ( test ( not ( instance-existp ( symbol-to-instance-name ( sym-cat crime_art155_1 ?Defendant ) ) ) ) ) => ( bind ?oid ( symbol-to-instance-name ( sym-cat crime_art155_1 ?Defendant ) ) ) ( make-instance ?oid of crime_art155_1 ( defendant ?Defendant ) ) )")
...
([rule9-deductive] of ntm-deductive-rule
   ...
   (implies crime_art154)
   (deductive-rule "?gen91 <- ( lc:case ( lc:defendant ?Defendant ) ( lc:injury_type \"teska tjelesna povreda\" ) ) ?gen92 <- ( lc:case ( lc:defendant ?Defendant ) ( lc:location \"Podgorici Kv\" ) ) ( not ( crime_art154 ( defendant ?Defendant ) ) ) => ( crime_art154 ( defendant ?Defendant ) )")
   (production-rule "( defrule rule9-deductive-gen123 ( declare ( salience ( calc-salience crime_art154 ) ) ) ( run-deductive-rules ) ( object ( name ?gen91 ) ( is-a lc:case ) ( lc:defendant ?Defendant ) ( lc:injury_type \"teska tjelesna povreda\" ) ) ( object ( name ?gen92 ) ( is-a lc:case ) ( lc:defendant ?Defendant ) ( lc:location \"Podgorici Kv\" ) ) ( not ( object ( is-a crime_art154 ) ( defendant ?Defendant ) ) ) ( test ( not ( instance-existp ( symbol-to-instance-name ( sym-cat crime_art154 ?Defendant ) ) ) ) ) => ( bind ?oid ( symbol-to-instance-name ( sym-cat crime_art154 ?Defendant ) ) ) ( make-instance ?oid of crime_art154 ( defendant ?Defendant ) ) )")
...
([rule8-deductive] of ntm-deductive-rule
   ...
   (implies crime_art153)
   (deductive-rule "?gen79 <- ( lc:case ( lc:defendant ?Defendant ) ( lc:injury_type \"teska tjelesna povreda\" ) ) ?gen80 <- ( lc:case ( lc:defendant ?Defendant ) ( lc:location \"Danilovgrad\" ) ) ( not ( crime_art153 ( defendant ?Defendant ) ) ) => ( crime_art153 ( defendant ?Defendant ) )")
   (production-rule "( defrule rule8-deductive-gen122 ( declare ( salience ( calc-salience crime_art153 ) ) ) ( run-deductive-rules ) ( object ( name ?gen79 ) ( is-a lc:case ) ( lc:defendant ?Defendant ) ( lc:injury_type \"teska tjelesna povreda\" ) ) ( object ( name ?gen80 ) ( is-a lc:case ) ( lc:defendant ?Defendant ) ( lc:location \"Danilovgrad\" ) ) ( not ( object ( is-a crime_art153 ) ( defendant ?Defendant ) ) ) ( test ( not ( instance-existp ( symbol-to-instance-name ( sym-cat crime_art153 ?Defendant ) ) ) ) ) => ( bind ?oid ( symbol-to-instance-name ( sym-cat crime_art153 ?Defendant ) ) ) ( make-instance ?oid of crime_art153 ( defendant ?Defendant ) ) )")
...
([rule7-deductive] of ntm-deductive-rule
   ...
   (implies crime_art152_2)
   (deductive-rule "?gen67 <- ( lc:case ( lc:defendant ?Defendant ) ( lc:injury_type \"laka tjelesna povreda\" ) ) ?gen68 <- ( lc:case ( lc:defendant ?Defendant ) ( lc:weapon \"metalni kljuc\" ) ) ( not ( crime_art152_2 ( defendant ?Defendant ) ) ) => ( crime_art152_2 ( defendant ?Defendant ) )")
   (production-rule "( defrule rule7-deductive-gen121 ( declare ( salience ( calc-salience crime_art152_2 ) ) ) ( run-deductive-rules ) ( object ( name ?gen67 ) ( is-a lc:case ) ( lc:defendant ?Defendant ) ( lc:injury_type \"laka tjelesna povreda\" ) ) ( object ( name ?gen68 ) ( is-a lc:case ) ( lc:defendant ?Defendant ) ( lc:weapon \"metalni kljuc\" ) ) ( not ( object ( is-a crime_art152_2 ) ( defendant ?Defendant ) ) ) ( test ( not ( instance-existp ( symbol-to-instance-name ( sym-cat crime_art152_2 ?Defendant ) ) ) ) ) => ( bind ?oid ( symbol-to-instance-name ( sym-cat crime_art152_2 ?Defendant ) ) ) ( make-instance ?oid of crime_art152_2 ( defendant ?Defendant ) ) )")
...
([rule5-deductive] of ntm-deductive-rule
   ...
   (implies crime_art151_5)
   (deductive-rule "?gen46 <- ( lc:case ( lc:defendant ?Defendant ) ( lc:injury_type \"teska tjelesna povreda\" ) ) ?gen47 <- ( lc:case ( lc:defendant ?Defendant ) ( lc:location \"Skadar\" ) ) ( not ( crime_art151_5 ( defendant ?Defendant ) ) ) => ( crime_art151_5 ( defendant ?Defendant ) )")
   (production-rule "( defrule rule5-deductive-gen119 ( declare ( salience ( calc-salience crime_art151_5 ) ) ) ( run-deductive-rules ) ( object ( name ?gen46 ) ( is-a lc:case ) ( lc:defendant ?Defendant ) ( lc:injury_type \"teska tjelesna povreda\" ) ) ( object ( name ?gen47 ) ( is-a lc:case ) ( lc:defendant ?Defendant ) ( lc:location \"Skadar\" ) ) ( not ( object ( is-a crime_art151_5 ) ( defendant ?Defendant ) ) ) ( test ( not ( instance-existp ( symbol-to-instance-name ( sym-cat crime_art151_5 ?Defendant ) ) ) ) ) => ( bind ?oid ( symbol-to-instance-name ( sym-cat crime_art151_5 ?Defendant ) ) ) ( make-instance ?oid of crime_art151_5 ( defendant ?Defendant ) ) )")
...
([rule4-deductive] of ntm-deductive-rule
   ...
   (implies crime_art151_4)
   (deductive-rule "?gen34 <- ( lc:case ( lc:defendant ?Defendant ) ( lc:injury_type \"teska tjelesna povreda\" ) ) ?gen35 <- ( lc:case ( lc:defendant ?Defendant ) ( lc:location \"Podgorica\" ) ) ( not ( crime_art151_4 ( defendant ?Defendant ) ) ) => ( crime_art151_4 ( defendant ?Defendant ) )")
   (production-rule "( defrule rule4-deductive-gen118 ( declare ( salience ( calc-salience crime_art151_4 ) ) ) ( run-deductive-rules ) ( object ( name ?gen34 ) ( is-a lc:case ) ( lc:defendant ?Defendant ) ( lc:injury_type \"teska tjelesna povreda\" ) ) ( object ( name ?gen35 ) ( is-a lc:case ) ( lc:defendant ?Defendant ) ( lc:location \"Podgorica\" ) ) ( not ( object ( is-a crime_art151_4 ) ( defendant ?Defendant ) ) ) ( test ( not ( instance-existp ( symbol-to-instance-name ( sym-cat crime_art151_4 ?Defendant ) ) ) ) ) => ( bind ?oid ( symbol-to-instance-name ( sym-cat crime_art151_4 ?Defendant ) ) ) ( make-instance ?oid of crime_art151_4 ( defendant ?Defendant ) ) )")
...
([rule3-deductive] of ntm-deductive-rule
   ...
   (implies crime_art151_3)
   (deductive-rule "?gen22 <- ( lc:case ( lc:defendant ?Defendant ) ( lc:injury_type \"teska tjelesna povreda\" ) ) ?gen23 <- ( lc:case ( lc:defendant ?Defendant ) ( lc:weapon \"staklena flasa\" ) ) ( not ( crime_art151_3 ( defendant ?Defendant ) ) ) => ( crime_art151_3 ( defendant ?Defendant ) )")
   (production-rule "( defrule rule3-deductive-gen117 ( declare ( salience ( calc-salience crime_art151_3 ) ) ) ( run-deductive-rules ) ( object ( name ?gen22 ) ( is-a lc:case ) ( lc:defendant ?Defendant ) ( lc:injury_type \"teska tjelesna povreda\" ) ) ( object ( name ?gen23 ) ( is-a lc:case ) ( lc:defendant ?Defendant ) ( lc:weapon \"staklena flasa\" ) ) ( not ( object ( is-a crime_art151_3 ) ( defendant ?Defendant ) ) ) ( test ( not ( instance-existp ( symbol-to-instance-name ( sym-cat crime_art151_3 ?Defendant ) ) ) ) ) => ( bind ?oid ( symbol-to-instance-name ( sym-cat crime_art151_3 ?Defendant ) ) ) ( make-instance ?oid of crime_art151_3 ( defendant ?Defendant ) ) )")
...
([rule2-deductive] of ntm-deductive-rule
   ...
   (implies crime_art151_2)
   (deductive-rule "?gen10 <- ( lc:case ( lc:defendant ?Defendant ) ( lc:injury_type \"teska tjelesna povreda\" ) ) ?gen11 <- ( lc:case ( lc:defendant ?Defendant ) ( lc:weapon \"metalni kljuc\" ) ) ( not ( crime_art151_2 ( defendant ?Defendant ) ) ) => ( crime_art151_2 ( defendant ?Defendant ) )")
   (production-rule "( defrule rule2-deductive-gen116 ( declare ( salience ( calc-salience crime_art151_2 ) ) ) ( run-deductive-rules ) ( object ( name ?gen10 ) ( is-a lc:case ) ( lc:defendant ?Defendant ) ( lc:injury_type \"teska tjelesna povreda\" ) ) ( object ( name ?gen11 ) ( is-a lc:case ) ( lc:defendant ?Defendant ) ( lc:weapon \"metalni kljuc\" ) ) ( not ( object ( is-a crime_art151_2 ) ( defendant ?Defendant ) ) ) ( test ( not ( instance-existp ( symbol-to-instance-name ( sym-cat crime_art151_2 ?Defendant ) ) ) ) ) => ( bind ?oid ( symbol-to-instance-name ( sym-cat crime_art151_2 ?Defendant ) ) ) ( make-instance ?oid of crime_art151_2 ( defendant ?Defendant ) ) )")
