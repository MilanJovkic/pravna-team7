...
export class VerdictDetailComponent implements OnInit {
  ...
  factualStateLabelMap: Record<string, string> = {
    ...
    attempted_offense: 'Pokušaj dela',
    imposed_prison_sentence_months: 'Izrečena kazna zatvora (meseci)',
  };
